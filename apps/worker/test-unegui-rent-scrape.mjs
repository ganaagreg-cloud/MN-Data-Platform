// Quick manual test: run the unegui.mn rent scraper end-to-end
// Usage: node --env-file=../../.env test-unegui-rent-scrape.mjs
import { runPipeline, sendTelegramMessage, formatListingAlert } from "@mn-platform/core";
import { uneguiRentSource } from "./src/sources/unegui-mn.js";
import { createDbAdapter } from "./src/db-adapter.js";
import { warnZeroValueListing } from "./src/sources/listing-schema.js";

const db = createDbAdapter();

console.log("🚀 Starting unegui.mn RENT scrape...\n");
